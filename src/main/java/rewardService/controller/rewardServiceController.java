...
public class rewardServiceController {
	...
	public Boolean isVisitorInAttraction(String userId, String visitedDate, String attraction, String visitorLocation) throws JsonMappingException, JsonProcessingException, ParseException {
		ObjectMapper mapper = new ObjectMapper();
		...
		return rewardService.nearAttraction(visitedLocation, attractionOk);
	}
